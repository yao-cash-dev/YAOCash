...
contract YAOToken is ERC20("YAOToken", "YAO"), Ownable {
    ...
    /// We need mint some YAO in advance
    uint256 public yaoInAdvance;
    ...
    /// @notice We need mint some YAOs in advance
    constructor(address _treasuryWalletAddr, uint256 _yaoInAdvance) {
        ...
        yaoInAdvance = _yaoInAdvance;

        mint(treasuryWalletAddr, yaoInAdvance);
    }
